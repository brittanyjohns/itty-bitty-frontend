...
import { IonPage, IonContent, IonInput, IonButton, IonText, IonButtons, IonHeader, IonMenuButton, IonTitle, IonToolbar, IonBackButton } from '@ionic/react';
          ...
          <div className="w-full max-w-xs">
            <form className="shadow-md rounded px-8 pt-6 pb-8 mb-4">
              ...
              <div className="flex items-center justify-between">
                <IonButton color="primary" className='w-full' onClick={handleSignUp}>
                  Sign Up
                </IonButton>
              </div>
            </form>
