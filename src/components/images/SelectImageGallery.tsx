          ...
          {remainingImages &&
            remainingImages.map((image, i) => (
              ...
              >
                ...
                />
                <div
                  className={`font-medium text-xs md:text-sm lg:text-md rounded-sm shadow-md bg-white bg-opacity-90 overflow-hidden absolute bottom-0 left-0 right-0 p-0 mt-2`}
                >
                  {image.label}
                  <audio>
