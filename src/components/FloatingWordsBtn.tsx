...
import { IonContent, IonFab, IonFabButton, IonFabList, IonHeader, IonIcon, IonLabel, IonTitle, IonToolbar } from '@ionic/react';
import {
  chevronDownCircle,
...
function FloatingWordsBtn() {
  ...
  return (
        <IonFab slot="fixed" vertical="bottom" horizontal="end">
          ...
          <IonFabList side="top">
            <IonFabButton onClick={() => say('please')} className="custom-fab-button">
              <IonLabel className='text-xs'>Please</IonLabel>
            </IonFabButton>
            <IonFabButton onClick={() => say('thank you')} className="custom-fab-button">
              <IonLabel className='text-xs'>Thank you</IonLabel>
            </IonFabButton>
            <IonFabButton onClick={() => say('hello')} className="custom-fab-button">
              <IonLabel className='text-xs'>Hello</IonLabel>
            </IonFabButton>
            <IonFabButton onClick={() => say('goodbye')} className="custom-fab-button">
